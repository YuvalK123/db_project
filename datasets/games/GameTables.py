...
def make_users():
    ...
    query = f"INSERT INTO admins (username, password, age, gender) " \
...
def create_games():
    # games =  gid, uid, current_score, strikes
    # locations = gid, location
    # letters = gid, letter
    games = [(1, 3, 122, 2), (2, 5, 7, 5), (3, 22, 14, 1)]
    locations = [(3, 1400), (3, 1412), (3, 502), (1, 202), (2, 305)]
    letters = [(1, 'b'), (1, 'f'), (1, 'z'), (2, 'e'), (2, 'm'), (3, 'a'), (3, 'i')]
    query = "INSERT INTO games (id, uid, current_score, strikes) VALUES (%s, %s, %s, %s);"
