...
def main():
    ...
    # create table of countries. it is important that the file of the data will be placed in the location specified.
    # countries file unites all the data in the file worldcitiespopi.csv for i between 1 to 8.
    ...
    # create the people info table. (at fir we thought add job_type in this table, and then decided otherwise.
    ...
    # create res_temp so that we could use the locations to our locations table
    ...
    # fetches the data from locations so we can insert the id's for the people's birth and death cities
    ...
    # those were temp tables, we need to delete them.
